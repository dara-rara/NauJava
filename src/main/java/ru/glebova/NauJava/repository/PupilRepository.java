...
public class PupilRepository implements CrudRepository<Pupil, Long> {
    ...
    public PupilRepository(Map<Long, Pupil> pupilContainer) { this.pupilContainer = pupilContainer; }
    ...
    public void update(Pupil pupil) {
        ...
        if (!pupilContainer.containsKey(pupil.getId())) {
